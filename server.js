...
container.resolve(function(users, _, group){
  ...
  console.log(uri)
  //const uri ="mongodb://ntheodoropoulos:nikblod1%21@cluster0-shard-00-00-ixtcj.mongodb.net:27017,cluster0-shard-00-01-ixtcj.mongodb.net:27017,cluster0-shard-00-02-ixtcj.mongodb.net:27017/test?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin&retryWrites=true&w=majority"
  ...
  function SetupExpress(){ // this function is the definition of the above one
    ...
    const io = socketIO(server); // adding multiple sockets to the server
  ...
  function ConfigureExpress(app){
    ...
    app.use(session({ // allows to save sessions
      secret: process.env.SECRET_KEY_WEBSOCK,
      resave: true,
